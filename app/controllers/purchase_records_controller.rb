...
def order_params
 params.require(:order).permit(:user_id, :item_id, :postcode, :prefecture_id, :city, :block_number, :building_name, :tel, :purchase_record_id).merge(user_id: current_user.id, item_id: params[:item_id])
end
end